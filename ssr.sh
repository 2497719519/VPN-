...
ss_link_qr(){
	...
	SSurl="ss://${SSbase64}"
	SSQRcode="http://xhn2.top/index/index/zxewm/api/api.php?text=${SSurl}"
...
ssr_link_qr(){
	...
	SSRQRcode="http://xhn2.top/index/index/zxewm/api/api.php?text=${SSRurl}"
...
在浏览器中，打开二维码链接，就可以看到二维码图片。
协议和混淆后面的[ _compatible ]，指的是 兼容原版协议/混淆。
接下来客户端下载和配置请参考小黑鸟博客：http://xhn2.top/250.html"
		echo && echo "==================================================="
	fi
	echo -e "小黑鸟导航：http://xhn2.top/"
	echo -e "小黑鸟博客搭建vpn教程：http://xhn2.top/"
	echo -e "更多文章：http://xhn2.top/"
	echo -e "进入小黑鸟博客 http://xhn2.top/ ，动动手指点个广告，举手之劳，博主就能吃上辣条！"
	echo "==================================================="
}
# 设置 配置信息
Set_config_port(){
